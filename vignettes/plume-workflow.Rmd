...
Enter your information and share the sheet to your collaborators so they can add theirs. You can do it either from Google Drive or in R using `googledrive::drive_share()`.

Once the sheet contains all author metadata, we can use `googlesheets4::read_sheet()` to read it in R.
