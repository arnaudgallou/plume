...
plume is designed to work with spreadsheets, which makes it easy to maintain and share data with co-authors. I recommend using [Google Sheets](https://docs.google.com/spreadsheets/) because it's easy to use and works great with the [googlesheets4](https://googlesheets4.tidyverse.org) package to manage sheets from R.
...
Enter your information and share the sheet to your collaborators so they can add theirs too. You can do it either from Google Drive or in R using `googledrive::drive_share()`.

Once the sheet contains all author metadata, we can use `read_sheet()` to read it in R.
...
To modify author data, simply edit the spreadsheet. All author information in the document will be automatically updated the next time you render it.
