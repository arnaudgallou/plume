...
- `Plume`: class that generates author lists and other author-related information as character vectors. This is an simple and convenient solution when you don't need preformatted documents.
